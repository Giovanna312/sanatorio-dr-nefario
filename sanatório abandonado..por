programa {
  funcao inicio() {
    cadeia nome,jogar,teste,esconder,armario
    inteiro senha
    ...
    escolha(jogar){
      caso "sim":
      escreva("Você é um exorcista e foi chamado pra documentar sanatório abandonado porque as pessoas que moravam perto estavam sentindo cheiros estranhos de lá, vendo bichos mortos pertos e escutando barulhos. Você não tinha muitas informações sobre o sanatório, apenas escutou relatos da vizinhança que luzes se acendem sozinhas nas janelas quebradas e alguns afirmam ter visto uma figura alta com jaleco branco os observando da torre principal, além do cheiro péssimo e animais mortos nas proximidades.\n")
      pare
      caso "não":
      ...
      //   
      escreva("Quando você chega nas redondezas, sente arrepios pelo corpo todo. Digite entrar para ir direto ao sanatório ou digite olhar em volta para explorar as redondezas: \n")
      leia(teste)
      escolha(teste){
      caso "entrar": 
